...
def companies_process_routine(new_date=current_checkpoint):
    print("Running Companies Processing Routine...")
    try:
        while True:
            try:
                ...
                process = Popen([
                    'python3',
                    os.path.join(path_to_base, 'routines/process_companies.py'),
                    "--date", new_date
                ],
                ...
                if "Parsing Completed" in e_str:
                    ...
                    print("Companies routine has processed data. "
                          "New checkpoint: (" +
                          new_datetime + ")" +
                          "\nSleeping 7 minutes and running again.")
