"""
Get Job titles
main function that parses API Job Titles.
"""

from routines import (
    extract_value_from_dict,
    extract_value_from_list_dict,
...
def get_job_titles(
        ...
        input_json: dict):
    """
    Converts a jobs dictionary to a parsed Title dictionary
    """
    ...
    match api_url:
        ...
        case ("https://jsearch.p.rapidapi.com"
            ...
            if nice_name == "Search Filters":
                result = (
                    extract_from_list_dict(
                        key_name='name',
                        list_new=dict_new.get('job_titles')
                    )
                )
        ...
        case ("https://real-time-glassdoor-data.p.rapidapi.com"
            ...
            if nice_name == "Company Reviews":
                result = dict_new.copy().get('reviews')
        ...
        case ("https://twitter-x-api.p.rapidapi.com"
            ...
            if nice_name == "Search Location":
                return (
                    {
                        "error":
                            "Job titles not in Search location "
                            "queries."
                    }
                )
        ...
        case ("https://glassdoor.p.rapidapi.com"
            ...
            if nice_name == "Locations Search":
                return (
                    {
                        "error":
                            "Job Titles not listed in Search location "
                            "queries."
                    }
                )
        ...
        case ("https://indeed12.p.rapidapi.com"
            ...
            if nice_name == "Company Search":
                return (
                    {
                        "error":
                            "Job titles not listed in data from API."
                    }
                )
        ...
        case ("https://jobs-api14.p.rapidapi.com"
            ...
            if nice_name == "Get salary range":
                return (
                    {
                        "error":
                            "Job Titles not listed in salary data."
                    }
                )
        ...
        case ("https://jobs-api14.p.rapidapi.com"
            ...
            if nice_name == "Get job titles":
                ...
                result = (
                    extract_value_from_list_dict(
                        key_name='jobTitle',
                        list_new=dict_new.get('jobTitles')
                    )
                )
        ...
        case ("https://indeed-scraper-api-germany.p.rapidapi.com"
            ...
            if nice_name == "Job View":
                ...
                for i in result.keys():
                    if result[i].find(':in') != -1:
                        result[i] = result[i].replace(':in', '')
        ...
        case ("https://linkedin-api8.p.rapidapi.com"
            ...
            if nice_name == "Get Company Details":
                return (
                    {
                        "error":
                            "Data from API doesn't include job titles."
                    }
                )
        ...
        case ("https://linkedin-live-data.p.rapidapi.com"
            ...
            if nice_name == "Company Search":
                return (
                    {
                        "error":
                            "Data does not include job titles."
                    }
                )
